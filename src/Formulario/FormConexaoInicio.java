...
public class FormConexaoInicio extends javax.swing.JFrame {

    
    public FormConexaoInicio() {
    ...
    private void initComponents() {
        ...
        setName("FormConexaoInicio"); // NOI18N
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormConexaoInicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormConexaoInicio().setVisible(true);
            }
        });
    }
